...
{
       0,    98,    98,   107,   108,   122,   123,   124,   125,   126,
     127,   128,   129,   132,   137,   144,   150,   158,   164,   172,
     173,   177,   183,   190,   191,   194,   195,   198,   204,   210,
     214,   223,   229,   230,   231,   232,   233,   234,   235,   236,
...
#line 133 "ast.y"
    {
        ...
        (yyval.node) = NULL; /* Declaração não gera nó executável */
    }
#line 1316 "ast.tab.c"
    break;
...
#line 184 "ast.y"
    {
        ...
        (yyval.node) = new_node(NODE_FOR, NULL, (yyvsp[0].node)); 
    }
#line 1391 "ast.tab.c"
    break;
